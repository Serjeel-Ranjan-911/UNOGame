...
const Stack = (props)=>{
    return (
        <div className={style.stack}>
            ...
            <img style={{transform: `rotateX(60deg) rotateY(0deg) rotateZ(-45deg) translateZ(21px)`}} className={style.stackCard} src={`/cards/Basic/${props.topcard}.svg`} onError={e=>e.target.src=`/cards/Basic/back.svg`}/>
        </div>
    )
}
